  ...
  static initialize () {
    ...
    this._intialized = expatInit.then(() => {
      ...
      this.SIMPLE = [
        ...
        this.CB_TYPES[lc] = expat.addFunction(this.pointers.call.bind(this.pointers, '_simple', lc))
        return o
      }, {})
      ...
      this.START_END = [
        ...
        this.CB_TYPES['start' + s] = expat.addFunction(this.pointers.call.bind(this.pointers, '_simple', 'start' + s))
        this.CB_TYPES['end' + s] = expat.addFunction(this.pointers.call.bind(this.pointers, '_simple', 'end' + s))
        return o
      }, {})
