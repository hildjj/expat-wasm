  ...
  */
  ...
  _elementDecl (event, name, model) {
    const m = this.__chase(model, {
      name: expat.Pointer_stringify(name)
    })
  ...
  _entityDecl (event, entityName, isParameterEntity, value, valueLength, base, systemId, publicId, notationName) {
    this.emit(
      event,
      expat.Pointer_stringify(entityName),
      !!isParameterEntity,
      value ? expat.Pointer_stringify(value, valueLength) : null,
      expat.Pointer_stringify(base),
      expat.Pointer_stringify(systemId),
      expat.Pointer_stringify(publicId),
      expat.Pointer_stringify(notationName))
  }
