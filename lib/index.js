...
export class XmlParser extends EventEmitter {
  ...
  constructor(encoding, separator = '|') {
    ...
    if (this.opts.base) {
      const baseType = typeof this.opts.base
      if (baseType !== 'string') {
        throw new Error(`base option must be string, not ${baseType}`)
      }
   ...
   */
  // eslint-disable-next-line max-params
  _externalEntityRef(event, parser, context, base, systemId, publicId) {
